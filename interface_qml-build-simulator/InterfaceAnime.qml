...
Item{
	...
	Item{
		...
		Connections {
	     ...
	     Text {id:vv; text :"Vites. vent : "+(interfce.getWindSpeed()*3.6).toFixed(2)+" Kmh"; x:dv.x; y:dv.y+20}
		 Text {id:sy; text :"Temps : "+interfce.getSymbol(); x:dv.x; y:vv.y+20}
		 Text {id:tem; text :"Temper. : "+interfce.getTemperature()+" C"; x:dv.x; y:sy.y+20}
		 
	  Timer {
         interval: 5000; running: true; repeat: true
         onTriggered: {	dv.text="Direct. vent : "+interfce.getWindDirection()
						vv.text="Vites. vent : "+interfce.getWindSpeed()*3.6+" Kmh";
